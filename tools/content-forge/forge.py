...
def choose_theme(rng: random.Random, index: int, bars: int) -> Theme:
    ...
    prompt = (
        ...
        "Keep the bass pocket simple and supportive, but add one short, tasteful syncopated "
        "bass pickup or melodic flourish in the final bar. Keep each instrument spectrally separate, dry, "
